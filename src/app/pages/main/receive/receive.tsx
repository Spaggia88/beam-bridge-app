...
import { IconCancel, IconCopyWhite, IconDai, IconEth, IconUsdt, IconWbtc } from '@app/icons';
...
const Receive = () => {
  ...
  const getFullLink = () => {
    return 'https://bridge-ethapp.web.app/send/' + (selectedCurrency.name.toLowerCase() + pKey);
  }
